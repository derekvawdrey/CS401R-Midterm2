...
class SnakeDQNAgent(BaseAgent):
    ...
    def __init__(
        ...
        """
        Initialize the DQN agent for Snake (legacy, kept for compatibility).
        
        Args:
            game: The game environment (FallingObjectsGame or MoveBasedSnakeGame instance)
...
class FallingObjectsDQNAgent(BaseAgent):
    """
    DQN Agent for the Falling Objects game.
    Wraps the DQNAgent to work with the game environment.
    """
    ...
    def __init__(
        ...
        """
        Initialize the DQN agent for Falling Objects game.
